...
const Footer = () => (
  <div className="container-fluid footer-wrapper">
    <div className="row">
      <div
        className="footer-sidebar-wrapper footer-sidebar-style-dark with-bg"
          ...
          <ul id="footer-sidebar" className="clearfix" style={{ padding: 0}}>
            <li id="text-2" className="widget widget_text">
              <div className="textwidget">
                ...
                <br />
                <p>
                  Certified by Visa International, MasterCard Incorporated,
                  Verve, GSMA and ISO 9001/2008 for Smart Card Manufacturing and
                  Personalization
                </p>
              </div>
            </li>
            ...
            <li id="text-3" className="widget widget_text">
              ...
              <div className="textwidget">
                ...
                <p>
                  T: +234 (0) 701460 8050
                  <br /> E:
                  <span className="text-color-theme">info@secureidltd.com</span>
                </p>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6 footer-copyright">
              <span> &copy; SecureID Limited - All right reserved</span>
            </div>
